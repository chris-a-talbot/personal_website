...
type ScrollProgressOptions = {
    threshold?: number;    // Minimum scroll amount before reporting progress (px)
    smooth?: boolean;      // Whether to smooth the progress value
    smoothingFactor?: number;  // How much to smooth (0-1, lower = smoother)
};
